...
## Algorithm used to make prediction {.smaller}
```{r,echo=TRUE}
...
## Functioning of the App {.smaller}
...
## Experience using the app {.smaller}
...
##The link for GITHUB and RPub {.smaller}

Below are the link for github 

https://github.com/SaraAlhosani/Final-Capstone

Below is the link for Rpub

https://rpubs.com/Sara_k/895091
